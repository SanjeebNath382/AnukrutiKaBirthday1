const STORE = {
 questions: {
  JustMummyThings: [
   {
    question: "Anukruti goes to the mall to buy this very special item, but she never buys it. Identify the item.",
    code: ``,
    answers: [
     "Jeans",
     "Bournvita",
   ...
   JustGudiyaThings: [{
    ...
    code: ``,
    answers: [
     "Dad Works in Customs",
     "She grabs her female friend",
     "She dead stares ",
     "All of the above"
    ],
